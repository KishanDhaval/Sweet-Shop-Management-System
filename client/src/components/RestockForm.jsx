...
const RestockForm = ({ sweet, onSubmit, onCancel }) => {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-gray-900">Restock Sweet</h2>
        <button
          onClick={onCancel}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <span className="text-gray-700">New Total Stock:</span>
